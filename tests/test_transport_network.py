...
TRANSPORT_NETWORK_CHECKSUM = 925935595
...
class Test_TransportNetwork:
    ...
    def test_init_from_files_and_dir_are_same(self,
        transport_network_from_test_files, transport_network_from_test_directory
    ):
        assert (
