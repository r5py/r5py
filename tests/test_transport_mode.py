...
class TestTransportMode:
    @pytest.mark.parametrize(
        ...
        [
            (r5py.TransportMode.AIR, "AIR", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.BUS, "BUS", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.CABLE_CAR, "CABLE_CAR", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.FERRY, "FERRY", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.FUNICULAR, "FUNICULAR", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.RAIL, "RAIL", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.SUBWAY, "SUBWAY", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.TRAM, "TRAM", com.conveyal.r5.api.util.TransportModes),
            (r5py.TransportMode.TRANSIT, "TRANSIT", com.conveyal.r5.api.util.TransportModes),
