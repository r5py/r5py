...
class TestTrip:
    def test_str(self):
        ...
        assert repr(trip) == "<Trip: 12.67m, 600.0s, <TripLeg: TransportMode.TRANSIT, 12.67m, 600.0s, (0.0, 0.0) -> (2.0, 2.0)>>"
    ...
    def test_summarised_properties(self):
        ...
        assert trip.transport_modes == [r5py.TransportMode.TRANSIT, r5py.TransportMode.TRANSIT]
