...
Rapid Realistic Routing on Real-world and Reimagined networks, the [routing engine](https://github.com/conveyal/r5)
developed by Conveyal. **r5py** is inspired by [r5r, a wrapper for R](https://ipeagit.github.io/r5r),
...
of the **r5py** ‘in action’ from the
[Usage](https://r5py.readthedocs.io/en/latest/notebooks/basic-usage.html) section of its
documentation. Over time, **r5py** will be expanded to incorporate other functionalities from R5.
